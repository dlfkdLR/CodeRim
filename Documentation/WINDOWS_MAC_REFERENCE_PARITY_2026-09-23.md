...
| WP-11 | Medium | Providers rows: account/plan/limit state, contextual connection action and alert bell | Implemented shared local identity/reading snapshot, stable rows, alert bell and connection actions; native execution and other-provider identity/routes remain open |
