...
| WP-16 | Low | Information Build row, link-row treatment, Codenotch MIT link and independent-project notice | Implemented; original LICENSE/NOTICE now bundled for offline reading; native layout/package check pending |
