...
final class NotchSessionCompletionTests: XCTestCase {
...
// `NotchPeekDurationTests` — the peek-length setting — lands in Phase 4 with
// the notch settings pane; `PeekDuration` is not ported yet.

/// The chime resolves files itself, so that resolution is worth checking.
final class NotchSessionChimeTests: XCTestCase {
