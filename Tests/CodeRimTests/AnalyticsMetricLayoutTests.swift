...
final class AnalyticsMetricLayoutTests: XCTestCase {
    ...
    private func recognizedText(_ host: NSView, name: String) throws -> String {
        ...
        if let path = ProcessInfo.processInfo.environment["CODERIM_METRIC_LAYOUT_DIR"] {
    ...
    private func normalized(_ text: String) -> String {
        // Vision on macOS CI can recognize the i in this complete word as l.
        // Normalize that single known glyph substitution, not missing/clipped text.
        text.lowercased().replacingOccurrences(of: "unavallable", with: "unavailable")
    ...
    private struct Fixture {
        ...
        let suite = "CodeRim.AnalyticsMetricLayout.\(UUID().uuidString)"
