...
@MainActor
final class NotchNotchRenderTests: XCTestCase {
...
@MainActor
final class NotchPanelSizingIntegrityTests: XCTestCase {
...
@MainActor
final class NotchEdgeCrossfadeTests: XCTestCase {
...
@MainActor
final class NotchEdgeArrivalTests: XCTestCase {
    private func pump(_ seconds: TimeInterval) {
        RunLoop.current.run(until: Date().addingTimeInterval(seconds))
    }
...
@MainActor
final class NotchAlwaysShowTests: XCTestCase {
...
final class NotchStaleAfterMarginTests: XCTestCase {
    private final class FailingProvider: NotchProvider, @unchecked Sendable {
        let id = "x"
        let displayName = "X"
        ...
        func fetchSnapshot() async throws -> ProviderSnapshot {
            ...
            throw NotchProviderError.badResponse(status: 500)
        }
    ...
    func testTheShippedDefaultsKeepTheSameMargin() {
        let store = NotchUsageStore(providers: [])
