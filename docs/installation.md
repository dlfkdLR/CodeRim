...
Save the DMG and [SHA256SUMS.txt](https://github.com/dlfkdLR/CodeRim/releases/download/v2.1.5/SHA256SUMS.txt) in the same folder and verify the download:

```sh
cd ~/Downloads
grep ' CodeRim-2.1.5.dmg$' SHA256SUMS.txt | shasum -a 256 -c -
```
